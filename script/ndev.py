# Using Nuance over Ivona. See https://developer.nuance.com//public/index.php?task=account for account details
# and http://nuancedev.github.io/samples/http/python/ for more.
